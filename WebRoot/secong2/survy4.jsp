...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
            <li class="active"><a href="../second/survy.jsp">学院简介</a></li>
            <li class="normal"><a href="survy2.jsp">机构设置</a></li>
            <li class="normal"><a href="survy3.jsp">院系领导</a></li>
            <li class="normal"><a href="survy4.jsp">师资队伍</a></li>
            <li class="normal"><a href="survy5.jsp">校友风采</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
	<div class="content_right">
    	<div id="myTab1_Content0"><div id="frameContent">
    			<%
					...
					PageBean<UserInfo> leader =UserManageProxy.getInstance().listByType(3,pageNow,"teacher") ;
