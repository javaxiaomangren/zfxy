...
<div class="content">
	...
	<div class="content_right">
    	    	<div id="myTab1_Content0"><div id="frameContent2">
    			<%
						PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(1, 1, "jgsz") ;
            ...
            <div class="borderHead1"><b><%=edu==null?"没有信息":edu.getTitle() %></b></div>
            	...
            	<div id="textContext"> 
  					<%=edu==null?"No information ":edu.getContent() %>
				 </div> </div>
