...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
                <li class="active"><a href="../second/science.jsp">科研项目</a></li>
            <li class="normal"><a href="science2.jsp">获奖项目</a></li>
            <li class="normal"><a href="science3.jsp">学术专著</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
	<div class="content_right">
    	<div id="myTab1_Content0">
            	...
            	<%
					...
					PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(20, pageNow, "hjxm") ;
           ...
           <div id="pages">
				<% if(result.getPageNow()>1){ %>
							<a href="../second/science2.jsp?pageNow=<%=result.getPageNow()-1 %>">上一页</a>
					 <%} %>
					 ...
					 <% if(result.getPageNow()<result.getPageCount()) {%>
					 			<a href="../secong2/science2.jsp?pageNow=<%=result.getPageNow()+1 %>">下一页</a>
					 <%} %></div> 	
        </div>
    </div>
</div>
