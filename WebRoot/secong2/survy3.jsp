	...
	<div class="content_right">
    	<div id="myTab1_Content0"><div id="frameContent">
    			<%
					...
					PageBean<UserInfo> leader =UserManageProxy.getInstance().listByType(3,pageNow,"leader") ;
			...
			<div id="pages">
				<% if(leader.getPageNow()>1){ %>
							<a href="../secong2/survy3.jsp?pageNow=<%=leader.getPageNow()-1 %>">上一页</a>
					 <%} %>
					 ...
					 <% if(leader.getPageNow()<leader.getPageCount()) {%>
					 			<a href="../secong2/survy3.jsp?pageNow=<%=leader.getPageNow()+1 %>">下一页</a>
					 <%} %>
                     </div> 	
           </div>
        </div>
