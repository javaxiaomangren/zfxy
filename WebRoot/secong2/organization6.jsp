	...
	<div class="content_right">
    	<div id="myTab1_Content0">
            	...
            	<%
					...
					PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(20, pageNow, "xsgzzlzx") ;
        		...
        		<tr>
        		 <td width="2%">&nbsp;</td>
        			<td width="60%"  height="25" nowrap="nowrap">
        				<a href="../third/organization.jsp_cont.jsp?id=<%=edu.getId() %>" ><%=edu.getTitle().equals("")==true?"":ShortString.shotTitle(edu.getTitle(),20) %></a></td>
           ...
           <div   id="pageInfo">
				<% if(result.getPageNow()>1){ %>
							<a href="organization6.jsp?pageNow=<%=result.getPageNow()-1 %>">上一页</a>
					 <%} %>
					 ...
					 <% if(result.getPageNow()<result.getPageCount()) {%>
					 			<a href="organization6.jsp?pageNow=<%=result.getPageNow()+1 %>">下一页</a>
					 <%} %></div> 	
        </div>
    </div>
</div>
