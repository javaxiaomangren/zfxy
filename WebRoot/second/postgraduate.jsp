...
<div class="content">
	...
	<div class="content_right">
    	<div id="myTab1_Content0">
           	<div id="frameContent">
           	 <div class="borderHead1"><div style="float:left;margin-left:200px; padding-top:5px;">研究生文件</div></div>
            			...
            			<table width="700">
							<tr>
						   	...
						   	<%
								...
								PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(20, pageNow, "yjsfile") ;
