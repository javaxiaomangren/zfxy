...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
            <li class="active" onclick="nTabs(this,0);"><a href="download.jsp">本科生</a></li>
            <li class="active" onclick="nTabs(this,0);"><a href="postgraduate.jsp">研究生</a></li>
            <li class="active" onclick="nTabs(this,0);"><a href="teacher.jsp">教师</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
	<div class="content_right">
    	<div id="myTab1_Content0">
           	<div id="frameContent">
           	 <div class="borderHead1"><div style="float:left;margin-left:200px; padding-top:5px;">本科生文件</div></div>
           	  <div class="borderHead1_bottom"></div>
            	<div id="textContent">
            		<!-- 内容 -->
            		<div class="dowloadContext">
            			<table width="700">
							<tr>
								<td width="10%">序号</td>
						    	<td width="50%">文件名称</td>
						   	...
						   	<%
								...
								PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(20, pageNow, "bksfile") ;
		     			 ...
		     			 <tr>
						    ...
						    <tr>
						    <td><%=i+1%></td>
						    	<td><%=ShortString.shotTitle(edu.getTitle(),30) %></td>
						        <td><%=edu.getAuther() %></td>
						        <td><%=edu.getAddDate() %></td>
						        <td><a href="../<%=edu.getContent() %>">下载</a></td>
						    </tr>
						    <%} }%>
						</table>
            		</div>
           ...
           <!-- 翻页 -->
        	   <% if(result.getPageNow()>1){ %>
							<a href="course.jsp?pageNow=<%=result.getPageNow()-1 %>">上一页</a>
					 <%} %>
					 ...
					 <% if(result.getPageNow()<result.getPageCount()) {%>
					 			<a href="course.jsp?pageNow=<%=result.getPageNow()+1 %>">下一页</a>
					 <%} %>
           </div> 	
        </div>
    </div>
