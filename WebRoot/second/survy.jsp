	...
	<div class="head">
    	...
    	<div style="width:309px; height:33px;padding-top:77px;">
        	<form id="form1" name="form1" method="post" action="?">
                  <label>
                  	</label><div style="background:url(../images/zuo.jpg) no-repeat; width:179px; height:33px; padding-left:7px; padding-top:7px; float:left;">
                    	<input name="k" type="text" id="k" value="" width="174" height="18" style="width:174px; height:18px; font-size:14px;"/>
                    </div>
                  
                  <label>
                  </label><div style=" background:url(../images/zhong.jpg) no-repeat; height:33px; width:74px; float:left; padding-top:6px; padding-left:0px;">
                  ...
                  <label>
                  </label><div style=" background:url(../images/you.jpg) no-repeat; width:44px; height:33px; float:right; padding-top:7px; padding-left:5px;">
...
<div id="menu">
 ...
 <ol class="no">
  <li onmouseover="javascript:ShowSpan(this,10);"><a href="../second/survy.jsp">学院简介</a>
   <span class="no">
   	<h1><a href="javascript:void(0);"></a></h1>
   </span>
  </li>
  <li onmouseover="javascript:ShowSpan(this,6);"><a href="../secong2/survy2.jsp">机构设置</a>
   <span class="no">
   	<h1><a href="javascript:void(0);"></a></h1>
   </span>
  </li>
  <li onmouseover="javascript:ShowSpan(this,7);"><a href="../secong2/survy3.jsp">院系领导</a>
   <span class="no">
   	<h1><a href="javascript:void(0);"></a></h1>
   </span>
  </li>
  <li onmouseover="javascript:ShowSpan(this,8);"><a href="../secong2/survy4.jsp">师资队伍</a>
   <span class="no">
   	<h1><a href="javascript:void(0);"></a></h1>
   </span>
  </li>
  <li onmouseover="javascript:ShowSpan(this,9);"><a href="../secong2/survy5.jsp">校友风采</a>
   <span class="no">
   	<h1><a href="javascript:void(0);"></a></h1>
   </span>
  </li>
...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
              <li class="active" onclick="nTabs(this,0);"><a href="#">学院简介</a></li>
            <li class="normal"><a href="../secong2/survy2.jsp">机构设置</a></li>
            <li class="normal"><a href="../secong2/survy3.jsp">院系领导</a></li>
            <li class="normal"><a href="../secong2/survy4.jsp">师资队伍</a></li>
            <li class="normal"><a href="../secong2/survy5.jsp">校友风采</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
	<div class="content_right">
        ...
        <div id="frameContent2">
    			<%
							PageBean<EduInfo> introduction =EduInfoProxy.getInstance().getInfoByType(1, 1, "introduction") ;
    						List<EduInfo> list = null ;
    						EduInfo edu = null ;
    						if(introduction!=null&&introduction.getResult()!=null&&introduction.getResult().size()!=0){
    							list = introduction.getResult() ;
    							if(list.size()>0)
    								edu = list.get(0) ;
    						}
						 %>
            	<div class="borderHead1"><b><%=edu==null?"没有信息":edu.getTitle() %></b></div>
           
            	<div id="textContent"> 
  					<%=edu==null?"没有信息":edu.getContent() %>
				 </div> 
             </div>
        </div>
    </div>
