...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
           <li class="active"><a href="orgBuild.jsp">组织建设</a></li>
            <li class="nomal"><a href="rule.jsp">章程条例</a></li>
            <li class="nomal"><a href="studyTrends.jsp">学习动态</a></li>
            <li class="nomal"><a href="creatAndBuilding.jsp" title="争先创优与学习型党组织建设">争先创优与学习型</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
	<div class="content_right">
    	<div id="myTab1_Content0">
            	...
            	<%
					...
					PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(20, pageNow, "zxcydj") ;
        		...
        		<tr>
        		 <td width="2%">&nbsp;</td>
        			<td width="60%"  height="25" nowrap="nowrap">
        					<a href="../third/orgBuild_cont.jsp?id=<%=edu.getId() %>"><%=edu.getTitle().equals("")==true?"":ShortString.shotTitle(edu.getTitle(),20) %></a></td>
           ...
           <div id="pageInfo">
				<% if(result.getPageNow()>1){ %>
							<a href="creatAndBuilding.jsp?pageNow=<%=result.getPageNow()-1 %>">上一页</a>
					 <%} %>
					 ...
					 <% if(result.getPageNow()<result.getPageCount()) {%>
					 			<a href="creatAndBuilding.jsp?pageNow=<%=result.getPageNow()+1 %>">下一页</a>
					 <%} %></div> 	
        </div>
    </div>
</div>
...
<div class="copyright">
	版权所有&copy&nbsp;哈尔滨师范大学政法学院网络中心&nbsp;&nbsp;<b>2011版</b><br />
