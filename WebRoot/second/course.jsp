...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
        <li class="active" onclick="nTabs(this,0);"><a href="#">精品课程</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
	<div class="content_right">
    	<div id="myTab1_Content0">
            	...
            	<%
					...
					PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(20, pageNow, "jpkc") ;
        		...
        		<tr>
        		 <td width="2%">&nbsp;</td>
        			<td width="60%"  height="25" nowrap="nowrap">
        				<a href="../third/course_cont.jsp?id=<%=edu.getId() %>"><%=edu.getTitle().equals("")==true?"":ShortString.shotTitle(edu.getTitle(),20) %></a></td>
