...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
              <li class="active"><a href="organization.jsp">学生工作</a></li>
            <li class="normal"><a href="studentActivities.jsp">学生活动</a></li>
            <li class="normal"><a href="sizheng.jsp">思政教育</a></li>
            <li class="normal"><a href="gonggao.jsp">公告平台</a></li>
            <li class="normal"><a href="honour.jsp">荣誉奖励</a></li>
            <li class="normal"><a href="studentServe.jsp">学生服务</a></li>
            <li class="normal"><a href="youth.jsp">青春飞扬</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
	<div class="content_right">
    	<div id="myTab1_Content0">
            	...
            	<%
					...
					PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(20, pageNow, "qcfy") ;
