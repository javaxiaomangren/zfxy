	...
	<div class="content_right">
    	<div id="myTab1_Content0">
            	...
            	<%
					...
					PageBean<EduInfo> result =EduInfoProxy.getInstance().getInfoByType(20, pageNow, "dzzjs") ;
           ...
           <div id="pageInfo">
				<% if(result.getPageNow()>1){ %>
							<a href="orgBuild.jsp?pageNow=<%=result.getPageNow()-1 %>">上一页</a>
					 <%} %>
					 ...
					 <% if(result.getPageNow()<result.getPageCount()) {%>
					 			<a href="orgBuild.jsp?pageNow=<%=result.getPageNow()+1 %>">下一页</a>
					 <%} %></div> 	
        </div>
    </div>
</div>
