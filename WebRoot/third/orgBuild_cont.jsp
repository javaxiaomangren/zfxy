...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
              <li class="active"><a href="../second/orgBuild.jsp">组织建设</a></li>
            <li class="nomal"><a href="../second/rule.jsp">章程条例</a></li>
            <li class="nomal"><a href="../second/studyTrends.jsp">学习动态</a></li>
            <li class="nomal"><a href="../second/creatAndBuilding.jsp">争先创优与学习型</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
