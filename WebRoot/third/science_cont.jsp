...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
           <li class="active" onclick="nTabs(this,0);"><a href="../second/science.jsp">科研项目</a></li>
            <li class="normal"><a href="../secong2/science2.jsp">获奖项目</a></li>
            <li class="normal"><a href="../secong2/science3.jsp">学术专著</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
