...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
            <li class="active" onclick="nTabs(this,0);"><a href=" ../second/secondDegree.jsp">函授</a></li>
           <li class="nomal" onclick="nTabs(this,1);"><a href="../second/selfExam.jsp">自考</a></li>
           <li class="nomal" onclick="nTabs(this,2);"><a href="../second/secondDegree2.jsp">二学历</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
