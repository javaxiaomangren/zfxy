...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
             <li class="active"><a href="../second/organization.jsp">学生团工委</a></li>
            <li class="normal"><a href="../secong2/organization2.jsp">学生会</a></li>
            <li class="normal"><a href="../secong2/organization3.jsp">社团联合会</a></li>
            <li class="normal"><a href="../secong2/organization4.jsp">艺术团</a></li>
            <li class="normal"><a href="../secong2/organization5.jsp">网络中心</a></li>
            <li class="normal"><a href="../secong2/organization6.jsp">学生工作助理中心</a></li>
            <li class="normal"><a href="../secong2/organization7.jsp">舍委会</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
