...
<div class="content">
	<div class="xgsm">
        <div id="menu2">
        <ul id="myTab1">
      		<li class="active"><a href="../second/examInformation.jsp">考研信息</a></li>
            <li class="nomal"><a href="../second/graduate.jsp">毕业手续</a></li>
            <li class="nomal"><a href="../second/jobInformation.jsp">招聘信息</a></li>
        </ul>
        <div class="cls"></div>
      </div>
     </div>
