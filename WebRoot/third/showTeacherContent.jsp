...
<%@page import="com.windy.zfxy.user.proxy.UserManageProxy"%>
    	...
    	<div id="myTab1_Content0"><div id="frameContent">
    			<%
    				...
    				if(request.getParameter("id")!=null&&request.getParameter("id").equals("")==false){
						UserInfo  content =UserManageProxy.getInstance().findUserById(request.getParameter("id")) ;
			   %>
       		     <div class="borderHead1"><b><%=content.getName() %></b></div>
            	<div id="textContent">
            		<%if(content.getHead()!=null&&content.getHead().trim().equals("")==false){ %>
            			 <div align="center"><img src="<%=content.getHead() %>" width="350" height="400" /></div>
            		<%} %>
		      <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            		 <%=content.getDetail() %><br/></div> 
            	<%} %>
            	</div>
